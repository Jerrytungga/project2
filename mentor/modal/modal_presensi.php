<div class="modal fade" id="presensi" tabindex="-1" aria-labelledby="presensi" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="presensi">Presensi</h5>
            ...
            <form action="" method="POST">
                ...
                <input type="text" class="form-control" id="efata" name="efata" value="<?= $_SESSION['id_Mentor']; ?>">
                    <input type="text" class="form-control" id="nis" name="nis" value="<?= $nis; ?>">
                    <h7>Total Presensi :</h7>
                    <div class="form-group">
                        <input type="text" class="form-control" id="total" name="total">
                    </div>
                    <h7 class="text-reset">Keterangan :</h7>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="btn_presensi" class="btn btn-primary">Save</button>
                </div>
            </form>
