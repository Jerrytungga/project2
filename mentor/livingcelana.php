...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingcelana.php" type="button" class="btn btn-outline-danger active mt-2">Celana Lipat & Dll</a>
    ...
    <!-- Modal living celana-->
    <div class="modal fade" id="livingcelana" tabindex="-1" aria-labelledby="livingcelana" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livingcelana">Celana Lipat & Dll</h5>
