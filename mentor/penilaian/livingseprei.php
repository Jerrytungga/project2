                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingranjang.php" type="button" class="btn btn-outline-primary mt-2">Bantal</a>
                            <a href="livingseprei.php" type="button" class="btn btn-outline-success active mt-2">Seprei</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="http://localhost/jurnal1/index.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
