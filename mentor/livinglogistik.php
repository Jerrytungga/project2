...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livinglogistik.php" type="button" class="btn btn-outline-primary active mt-2">Logistik & Make Up</a>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-3">
                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#livinglogistik">Input</a>
                        </div>
                        <div class="card-body">
    ...
    <!-- Modal living logistik -->
    <div class="modal fade" id="livinglogistik" tabindex="-1" aria-labelledby="livinglogistik" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livinglogistik">Logistik & Make up</h5>
