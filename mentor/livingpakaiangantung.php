...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingpakaiangantung.php" type="button" class="btn btn-outline-warning active mt-2">Pakaian Gantung</a>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-3">
                            <a href="" class="btn btn-warning" data-toggle="modal" data-target="#bajugantung">Input</a>
                        </div>
                        <div class="card-body">
    ...
    <!-- Modal baju gantung-->
    <div class="modal fade" id="bajugantung" tabindex="-1" aria-labelledby="bajugantung" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="bajugantung">Baju Gantung</h5>
