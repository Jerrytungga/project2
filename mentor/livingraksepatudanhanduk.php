...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingraksepatudanhanduk.php" type="button" class="btn btn-outline-primary active mt-2">Rak Sepatu</a>
    ...
    <div class="modal fade" id="livingraksepatu" tabindex="-1" aria-labelledby="livingraksepatu" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livingraksepatu">Rak Sepatu</h5>
