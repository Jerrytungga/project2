...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingdalaman.php" type="button" class="btn btn-outline-success active mt-2">Pakaian Dalam</a>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-3">
                            <a href="" class="btn btn-success" data-toggle="modal" data-target="#livingdalaman">Input</a>
                        </div>
                        <div class="card-body">
    ...
    <!-- Modal living dalaman -->
    <div class="modal fade" id="livingdalaman" tabindex="-1" aria-labelledby="livingdalaman" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livingdalaman">Pakaian Dalam</h5>
