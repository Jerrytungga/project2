...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livinghanduk.php" type="button" class="btn btn-outline-success active mt-2">Handuk</a>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-3">
                            <a href="" class="btn btn-success" data-toggle="modal" data-target="#livinghanduk">Input</a>
                        </div>
                        <div class="card-body">
    ...
    <!-- Modal living handuk-->
    <div class="modal fade" id="livinghanduk" tabindex="-1" aria-labelledby="livingrakhanduk" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livinghanduk">Handuk</h5>
