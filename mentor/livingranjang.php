...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="group">
                            ...
                            <a href="livingranjang.php" type="button" class="btn btn-outline-primary active mt-2">Bantal</a>
                            <a href="livingseprei.php" type="button" class="btn btn-outline-success mt-2">Seprei</a>
                            <a href="livingselimut.php" type="button" class="btn btn-outline-warning mt-2">Selimut</a>
                            <a href="living_ranjang.php" type="button" class="btn btn-outline-danger mt-2">Ranjang</a>
                    ...
                    <div class="card shadow mb-4 ">
                        <div class="card-header py-3">
                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#livingbantal">Input</a>
                        </div>
                        <div class="card-body">
    ...
    <!-- Modal living ranjang/bantal-->
    <div class="modal fade" id="livingbantal" tabindex="-1" aria-labelledby="livingbantal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold" id="livingbantal">Bantal</h5>
